  ...
  return (
    <div>
      <footer className="relative py-10 flex flex-col items-center bg-cyan-900 overflow-hidden md:py-20">
        <div className="relative z-[1] container m-auto px-6 md:px-0">
          <div className="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
            <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
              <div className="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
                ...
                <ul role="list" className="space-y-8 px-16 py-2"><li>
                    <a
                      href="https://www.instagram.com/team__405_?utm_source=qr&igsh=ams3aDQ3bmJvc2Rs"
                      target="_blank"
                  ...
                  <li>
                    <a
                      href="https://x.com/_team405_?t=fKA3DJskd4ggOetugOi8HA&s=08"
                      className="flex items-center space-x-3 hover:text-sky-400 transition"
                      target="_blank"
                    >
                      <svg
                  ...
                  <li>
                    <a
                      href="https://www.youtube.com/channel/UCAL_XXInL47ZSAkGth_crCw"
                      className="flex items-center space-x-3 hover:text-sky-400 transition"
                      target="_blank"
                    >
                      <svg
              ...
              <div className="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
                <span className="block text-gray-300">
                  All our links in One Piece
                </span>

                <span className="block text-gray-300">
                  Tablet Vending Machine &copy; 2024
                </span>
                <span className="block text-gray-300">
                  Team 405
                </span>
                ...
                <span className="block text-gray-300">
                  For business queries and others{" "}
                  <a href="/contact" className="font-semibold text-white flex">
                    {" "}
                    Contact Us
                  </a>
                </span>
